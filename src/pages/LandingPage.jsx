    ...
    <div className="w-full">
      <section className="flex flex-col items-center text-center py-20 px-6">
        ...
        <p className="text-lg text-gray-600 max-w-xl mb-8">
          ...
          akses bagi dosen untuk memantau perkembangan akademik secara real-time
        </p>
        <ButtonWithIcon
      ...
      <section id="features" className="bg-white py-16 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600">
              Diskusikan materi dan terima komentar dari dosen maupun mahasiswa
              lain.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600">
              Pantau performa akademik lewat grafik yang informatif dan menarik.
            </p>
          </div>
        </div>
      </section>
